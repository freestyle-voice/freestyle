...
- **Remix** A focused chat workspace for asking, writing, researching, and keeping task context close without leaving the conversation.
...
<CardGroup cols={2}>
  <Card title="User guide" icon="book-open" href="/user-guide">
    The everyday features: dictation, Remix, models, cleanup, dictionary, and formats.
  </Card>
  <Card title="Remix" icon="wand-magic-sparkles" href="/features/remix">
    Use the agent workspace, its hotkey, and its contextual Tasks, Notes, and Brain cards.
  </Card>
