...
export default function AppShell(): React.JSX.Element {
  ...
  // A plugin page renders a native WebContentsView that sits above the DOM, so
  // the floating social bar would be occluded (and leave a border seam). Hide
  // it while a plugin page is open. Matches /plugins/<slug>/<pageId>.
